      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Transform AI-generated text into natural, human-like content with balanced synonym replacement
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card">
            ...
            <textarea
              ...
              className="textarea-custom h-64 mb-4"
              maxLength={3000}
            />
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Only professional style supported</p>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="aggressive">Aggressive (Balanced Synonyms)</option>
                  </select>
                  <p className="text-xs text-gray-500 mt-1">Uses WordsAPI with smart filtering for readability</p>
                </div>
              </div>
            ...
            {result && status === 'success' && (
              <>
                <textarea
                  ...
                  readOnly
                  className="textarea-custom h-64 mb-4 bg-gray-50"
                />
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">{result.statistics.changesCount}</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Words</p>
                      <p className="font-medium">
                        {result.statistics.originalWordCount} → {result.statistics.humanizedWordCount}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-500">Readability</p>
                      <p className="font-medium">{result.statistics.readabilityScore.toFixed(1)}/10</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Processing Time</p>
                      <p className="font-medium">{result.processingTime.toFixed(1)}s</p>
                    </div>
                  </div>
                </div>
              </>
